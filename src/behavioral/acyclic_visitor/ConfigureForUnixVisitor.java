...
public class ConfigureForUnixVisitor {
    public ModemVisitor<Zoom> getZoomVisitor() {
        return new ModemVisitor<Zoom>() {
            @Override
            public void visit(Zoom zoom) {
                System.out.println(zoom + " visited by ConfigureForUnixVisitor");
            }
        };
    }
    ...
    public ModemVisitor<Hayes> getHayesVisitor() {
        return new ModemVisitor<Hayes>() {
            ...
            public void visit(Hayes hayes) {
                System.out.println(hayes + " visited by ConfigureForUnixVisitor");
            }
        };
    }
}
